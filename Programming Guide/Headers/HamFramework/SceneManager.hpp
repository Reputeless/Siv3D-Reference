...
namespace ham
{
	...
	public:
		...
		/// シーン管理のオプション
		/// </param>
		SceneManager(SceneManagerOption option = SceneManagerOption::None)
		...
		/// シーン管理のオプション
		/// </param>
		SceneManager(const std::shared_ptr<Data>& data, SceneManagerOption option = SceneManagerOption::None)
			: m_data(data)
			, m_option(option) {}
