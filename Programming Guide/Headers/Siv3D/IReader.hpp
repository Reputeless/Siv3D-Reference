...
namespace s3d
{
	...
	public:
		...
		/// 実際に読み込んだサイズ（バイト）
		/// </returns>
		virtual int64 read(_Out_writes_bytes_all_(size) void* buffer, int64 size) = 0;
		...
		/// 実際に読み込んだサイズ（バイト）
		/// </returns>
		virtual int64 read(_Out_writes_bytes_all_(size) void* buffer, int64 pos, int64 size) = 0;
		...
		/// 実際に読み込んだサイズ（バイト）
		/// </returns>
		virtual int64 lookahead(_Out_writes_bytes_all_(size) void* buffer, int64 size) const = 0;
		...
		/// 実際に読み込んだサイズ（バイト）
		/// </returns>
		virtual int64 lookahead(_Out_writes_bytes_all_(size) void* buffer, int64 pos, int64 size) const = 0;
