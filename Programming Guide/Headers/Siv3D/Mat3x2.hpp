...
namespace s3d
{
	...
	struct Mat3x2
	{
		...
		constexpr Mat3x2(float _11, float _12, float _21, float _22, float _31, float _32)
			: _11{ _11 }
			, _12{ _12 }
			, _21{ _21 }
			, _22{ _22 }
		...
		void setProduct(const Mat3x2 &a, const Mat3x2 &b)
		{
	...
	template <class CharType>
	inline std::basic_istream<CharType>& operator >> (std::basic_istream<CharType>& is, Mat3x2& mat)
	{
		CharType unused;
		Float2 r1, r2, r3;
